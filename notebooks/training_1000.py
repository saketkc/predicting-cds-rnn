    ...
    for e in range(nb_epoch):
        ...
        for x, y in zip(X_train, Y_train):
            ...
            if (index%500) == 0:
                ...
                with open('train_acc_1000.log', 'a') as f:
        ...
        with open('test_acc_1000.log', 'a') as f:
            f.write('Epoch: {} || Test acc: {}\n'.format(e, acc_test))

        model.save('lstm-dropout_025_recur_dropout_025-epoch-{}_1000.h5'.format(e))
...
model.save('lstm-dropout_025_recur_dropout_025-all_1000.h5')


# In[ ]:


with open('train_hist_025_recur_dropout_025_1000.pickle', 'wb') as f:
